	...
	public OtherGlassPane() {
		...
		addMouseListener(new MouseListener() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (e.getX() > 750 && e.getX() < 750 + 400 && e.getY() > 300 && e.getY() < 400) { // bouton compléter le
																									// programme
					Game.etatPartie = EtatPartie.COMPLETER;
					Game.fenetre.repasserEnJeu();
					Game.fenetre.ajouterListeners();
				} else if (e.getX() > 750 && e.getX() < 750 + 400 & e.getY() > 500 && e.getY() < 600) { // bouon
																										// contruire un
																										// mur
					Game.etatPartie = EtatPartie.CONSTRUIRE;
					Game.fenetre.repasserEnJeu();
					InventairePanel.activeLesMurs();
				} else if (e.getX() > 750 && e.getX() < 750 + 400 & e.getY() > 700 && e.getY() < 800) { // bouton
																										// executer le
																										// programme
