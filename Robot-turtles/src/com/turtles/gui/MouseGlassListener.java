...
public class MouseGlassListener extends MouseAdapter {
	...
	public void mousePressed(MouseEvent event) {
		...
		if (composant.getName().contentEquals("CardPanel")) {
			...
			// On n'oublie pas de dire à notre GlassPane de s'affiche
	...
	/*
	 * fonction non utilisée public void dropMur(int xScreen, int yScreen) {
	 * 
	 * int x = 0; int y = 0;
	 * 
	 * if (yScreen > 343 && yScreen <= 395) { y = 0; } else if (yScreen > 395 &&
	 * yScreen <= 446) { y = 1; } else if (yScreen > 446 && yScreen <= 500) { y = 2;
	 * } else if (yScreen > 500 && yScreen <= 551) { y = 3; } else if (yScreen > 551
	 * && yScreen <= 604) { y = 4; } else if (yScreen > 604 && yScreen <= 655) { y =
	 * 5; } else if (yScreen > 655 && yScreen <= 700) { y = 6; } else if (yScreen >
	 * 700 && yScreen <= 758) { y = 7; }
	 * 
	 * if (xScreen > 740 && xScreen <= 794) { x = 0; } else if (xScreen > 794 &&
	 * xScreen <= 850) { x = 1; } else if (xScreen > 850 && xScreen <= 905) { x = 2;
	 * } else if (xScreen > 905 && xScreen <= 960) { x = 3; } else if (xScreen > 960
	 * && xScreen <= 1015) { x = 4; } else if (xScreen > 1015 && xScreen <= 1070) {
	 * x = 5; } else if (xScreen > 1070 && xScreen <= 1125) { x = 6; } else if
	 * (xScreen > 1125 && xScreen <= 1180) { x = 7; }
	 * 
	 * 
	 * }
	 */
