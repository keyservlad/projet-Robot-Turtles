...
import com.turtles.Sound;

public class Fenetre extends JFrame implements ActionListener, KeyListener{ // le keylistener ne marche plus
	...
	public void afficherFenetreMenu() {
		...
		musicButton.setBounds((int) (this.getWidth() * 0.8), (int)(this.getHeight() * 0.8), (int) musicButton.getPreferredSize().getWidth(), (int) musicButton.getPreferredSize().getHeight());
	...
	public void afficherEcranTourDuJoueur() {
		...
		if (Game.tourDuJoueur == 0) {
			color = Color.red;
		}else if (Game.tourDuJoueur == 1) {
			color = Color.green;
		}else if (Game.tourDuJoueur == 2) {
			color = Color.blue;
		}else if (Game.tourDuJoueur == 3) {
			color = Color.yellow;
		}
